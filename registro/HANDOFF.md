...
### 15.30 Cierre del 22-sep-2026

**Corrido y registrado hoy (branches `carrera-escuderias`, `mundo-anclado`, `rama-fanin`, `aprende-barrer`, `generaciones-conviven`, todas integradas a `main` a las 20:42):** fase 10 externa integrada (calibración de F1 cae, H-BOCA reproducida en dirección) · diagnóstico del muro (H-MURO se sostiene, pastoreo selectivo real pero menor de lo esperado) · criterio de tronco v4 calibrado y replicado (UTILIZABLE; v3 retirado) · carrera de escuderías: reglamento aprobado, ronda 0 (línea base), ronda 1 y serie sellada (**primer cruce de H-1 en JUACO por la letra**, R0 real 0.941), auditoría ERR-100/101 y S-FUNDBORRA sellada (descarta el artefacto de memoria), ronda 2 de combos Opus y réplica sellada (**O3 y O4 estabilizan el bicho, replicado, con muerte programada declarada; O2 estabiliza sin ella**) · mundo anclado v1 (NO) y v2 (HAY ALGO MODESTO, cerrado con reservas) · fanin (CAE la hipótesis del director, replicada) · aprende a barrer / camino A (HAY ALGO MODESTO pendiente de réplica, no corrida) · generaciones que conviven (instrumento y quimiostato listos, ERR-104, sin series de T=100000).

**Preparado y pendiente:** réplica de aprende_barrer (8121–8140); fila tox 2.0 del mundo anclado v2; series de T=100000 de generaciones que conviven (monocultivos + réplica + pista mixta, comandos en `INFORME_CONVIVE.md`); semillas 2441–2840 de la fase 10 externa (exploración con retina vacía antes que la boca); versión de retina grande (~50 entradas) para la línea de fanin.

**Decisiones del director con hora y palabras:** 12:23 "córrelo" (reglamento de la carrera de escuderías); 12:51 opción A de percepción de la pista escalada; delegación general "las otras tú decides, basado en el objetivo" (fijó nivel 9 al 50 %, v4 en construcción, dos Pools con tope de 14 procesos, V-5 en espera — todo tomado y ejecutado por el coordinador durante el día); pedido de mitad de tarde: mandar mundo anclado y carrera "las dos al tiempo… en branches distintas"; sobre el mundo anclado, "córrela así y probamos la hipótesis"; sobre la ronda 2, "solo con Opus, y dos agentes más por combo… estabilizar el maldito bicho"; "haz ese mundo donde convivan las generaciones"; cierre de jornada: "deja las fases largas para mañana, el cómputo se apaga a las 10".

**Próximo candidato para el 23-sep, en orden:** (1) series de generaciones que conviven — comandos ya escritos en `experimentos/generaciones/INFORME_CONVIVE.md`; (2) Escuela de abejas con protocolo formal (hoy corrió una versión exploratoria sin preregistro ni arnés de identidad, rama `escuela-exploratoria`, integrada a main a las 20:58 (`2219aba`) SOLO como EXPLORATORIO, no es dato: mini-mundo de sumar con bits, la alumna aprende el XOR sólo si tiene detector de pares, la "sabia" ayuda sobre todo por copia y es una muleta si la alumna no puede aprender sola — si algo de esto apunta al tronco, se rehace con protocolo); (3) JUACO-ECO.

**ERR nuevos (rango 94–113):** 94 (v4, resuelto: utilizable) · 95–103 (carrera de escuderías, reglamento y auditorías) · 104 (quimiostato, capacidad de carga del mundo con generaciones solapadas) · 105–110 (fase 10 externa, Anexo B-1..B-6) · 111–113 (auditoría del mundo anclado v2, H-1/H-3/H-4).

**Quién retome lee, en este orden:** `registro/ESTADO.md` (todavía sin reescribir desde el 21-sep 22:50: la tabla de niveles y el bloque de tronco están un día atrasados) → las nuevas entradas de hoy en `registro/REGISTRO_etapas_1_2.md` (desde "FASE 10 EXTERNA" hasta "GENERACIONES QUE CONVIVEN") → `experimentos/carrera_escuderias/REGLAMENTO.md` (contiene las seis enmiendas completas y es el documento vivo de la carrera).
