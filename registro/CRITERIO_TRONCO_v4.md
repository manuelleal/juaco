...
| **T-B** | **generaliza** a nunca vistos | `bateria_generaliza` G1/G2 | G1 ≥ 0.80, G2 ≥ 0.85, azar en [0.35, 0.65] (G2 en **[0.31, 0.60] desde ERR-122**, 23-sep: antes [0.42, 0.58], que dejaba pasar al propio tronco sólo 0.55 bajo su nulo), K 20/20. | Umbral lejos del nulo (azar 0.50). **No calibrado con placebo** (ver §7). |
