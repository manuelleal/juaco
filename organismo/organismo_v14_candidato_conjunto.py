"""PROPUESTA CONJUNTA DE v14 (rama v14-candidato; NO es tronco hasta que el director decida): copia de
experimentos/nivel10_composicion_v14/organismo_v14c_on.py = organismo_v13 (cc8b16b492d4d324) + hija dispersa por relevancia (mask_rel=2)
+ puerta de familiaridad por evidencia del codigo exacto (puerta_pat=5, pat_min=1), perillas fijas ON. Examen v3' 8/8 (121-140),
G1 1.000 / G2 0.94, N* 51, 3T-k 0.237 con 53 celdas. Evidencia: registro/PROPUESTA_v14.md.
"""
