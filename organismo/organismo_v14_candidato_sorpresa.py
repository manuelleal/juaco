"""SEGUNDO CANDIDATO A v14 (rama v14-candidato; NO es tronco hasta que el director decida): copia de
experimentos/nivel9_probar_si_mismo/organismo_v13E_k5.py = organismo_v13 (cc8b16b492d4d324) + predictor de la propia energia (dE)
cuya sorpresa entra en la BOCA con k_testE = 5 (eta_pred 0.03, ema_pred 0.05), perillas fijas ON. Evidencia: registro/PROPUESTA_v14.md.
"""
"""organismo_v13E_k5 = organismo_v13p.py (2dbed7ccac4dd736) + dE-TEST FIJO ON por defecto: eta_pred=0.03, ema_pred=0.05,
k_testE=5.0 -- DOSIS preregistrada en PREREGISTRO_dosis_dE.md (mismo mecanismo de organismo_v13E, ganancia
menor). Generado por construye_v13E.py --k 5. NO editar a mano. Con eta_pred=ema_pred=k_testE=0 es
