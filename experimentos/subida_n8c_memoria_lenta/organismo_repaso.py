"""organismo_repaso = experimentos/subida_n8/organismo_flujo.py (14afed5aa16e09bf) + perilla `repaso`
...
def run(seed,T=100000,learn=True,plan=None,pats=None,chk=None,
        ...
        plast=True,theta=0.6,ema=0.02,paso=0.5,lam=0.0,memoria_rechazo=20,mu_norm=False,div_signo=False,eta_s=0.0,clip_s=3.0,puerta=None,puerta_pat=5,pat_shuf=0,pat_min=1,mask_rel=2,del_s=0.25,del_c=0.25,ema_c=0.05,ventana=0,p_viejo=0.25,fusion=0,repaso=0,dosis=1):
