"""CTRL_O3_SINTERM (construido por experimentos/generaciones/construye_ctrl_o3.py desde carros/O3.py sha 0442c2884fcb0e11; UNICO cambio: TERMINAL = False). carros/O3.py — escuderia O3 (combo Opus: disenador + biologo + critico). Carrera de escuderias, RONDA 2 (ENMIENDA 5).
