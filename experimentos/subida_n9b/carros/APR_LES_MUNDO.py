"""APR_LES_MUNDO (construido por experimentos/subida_n9b/construye_n9b.py desde carrera_escuderias/carros/APR.py sha 4402aa5142065c72; instrumento de LESION de la prediccion de si, perillas LES_PRED / LES_MUNDO; apagadas = APR bit a bit). carros/APR.py — APR (camino A, experimentos/aprende_barrer): FABRICA + la OPCION APRENDIDA de morder lo malo conocido.
...
LES_PRED = None     # None | 'plana' (post = u actual) | 'cruz' (efecto sentido aplicado a la OTRA necesidad)
LES_MUNDO = True    # True: g0 y dist con lo bueno para la necesidad NO activa (control de especificidad)
