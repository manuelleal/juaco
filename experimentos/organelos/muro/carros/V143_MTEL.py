"""V143_MTEL.py — muro: V143 + UNA pieza local del bloque MURO (la de sus perillas; ver construye_muro.py). Cero memoria nueva.
GENERADO por experimentos/organelos/muro/construye_muro.py desde tronco_v14_3/carros_v143/V143.py (sha 2a03048a7f1525e5).
NO editar a mano. Perillas: PAGA = 0; GLOT = 0; PATAS = 0; TELEM = 1. Con PAGA = GLOT = PATAS = TELEM = 0 es V143 bit a bit. Sigue el docstring de V143.
...
PAGA = 0; GLOT = 0; PATAS = 0; TELEM = 1   # muro: LA UNICA LINEA QUE CAMBIA ENTRE VARIANTES (0/0/0/0 = V143 bit a bit)
