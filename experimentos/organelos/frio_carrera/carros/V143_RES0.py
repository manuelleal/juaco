"""V143_RES0.py — frio_carrera (F1 en la pista de la carrera): V143 + el nacido lee el nodo del linaje sin neutras.
...
NO editar a mano. Perillas: RES0 = 1; BAR = 0; TELEM = 1. Con RES0 = BAR = TELEM = 0 es V143 bit a bit. Sigue el docstring de V143.
...
RES0 = 1; BAR = 0; TELEM = 1   # frio_carrera: LA UNICA LINEA QUE CAMBIA ENTRE VARIANTES (0/0/0 = V143 bit a bit)
