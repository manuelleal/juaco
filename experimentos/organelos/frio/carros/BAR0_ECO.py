"""carros/BAR0_ECO.py (CONSTRUIDO por experimentos/organelos/frio/construye_frio.py desde juaco_eco/carros/FAMB_RES0_ECO.py, sha 94ea78589bc2ce24; NO editar a mano). F1 ARRANQUE EN FRIO: control de CONTENIDO BAR0 = MODO 'bar' con SIN0 = 1 (el
