"""carros/FABRICA_SIMB.py (CONSTRUIDO por experimentos/organelos/darwin/construye_endo.py desde juaco_eco/carros/FABRICA_ECO.py, sha f1163009cb5193a2; NO editar a mano).
UNICO cambio: el CANAL del simbionte (obs['simb'] = letra -> numero) se SUMA a la entrada de la boca Vb. Sin obs['simb'] es FABRICA_ECO bit a bit.
Lo que sigue es el docstring del origen.

carros/FABRICA_ECO.py (CONSTRUIDO por experimentos/juaco_eco/construye_eco.py desde carrera_escuderias/carros/FABRICA.py, sha 2ebee3e99ea5a33a; NO editar a mano). Unico cambio: _see() hacia afuera
(O(distancia), misma salida; arnes (F)) y la funcion _elige. Lo que sigue es el docstring del origen.
