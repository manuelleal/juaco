...
class Cuerpo:
    ...
    def __init__(self, lin, k, gen, padre, tn, c, ident, vista, pos, E, fund, pc=None):
        ...
        self.hijos = 0; self.fund = fund; self.vivo = True; self.hvivos = 0; self.pc = pc; self.g = None; self.s = None; self.sm = None; self.sm_nac = 0; self.sm0 = None   # ENDO G2 · pc = cuerpo padre (vivo o no)
