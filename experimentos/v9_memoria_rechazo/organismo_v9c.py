"""organismo_v9c = organismo_v9 + memoria_modo (control C1 de PREREGISTRO_v9.md). NO es tronco."""
"""
...
def run(seed,T=100000,learn=True,invertir_en=None,nuevo=None,nuevo_en=50000,nuevo_val='veneno',solap_B=None,
        eta=.03,tau_e=.85,alpha=1.2,hambre_boca=2.0,aversion=1.0,costo=.002,nobj=4,log_cada=None,plast=True,theta=0.6,ema=0.02,paso=0.5,solap_AB=None,lam=0.05,memoria_rechazo=20,memoria_modo='rechazado'):
    rng=np.random.default_rng(seed)
    rng2=np.random.default_rng(seed+200000)   # v9c: RNG separado para el control C1
