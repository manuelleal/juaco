"""
organismo_v6_sonda.py = organismo/organismo_v6.py (hash 5f38f83cf49248a3) + instrumentacion inerte.
UNICO cambio funcional: run() devuelve ademas Wp, Wn y KW (arrays finales) en el dict de retorno.
Cero llamadas nuevas al RNG, cero cambios en la dinamica. Equivalencia verificada frente a v6.
...
def run(seed,T=100000,learn=True,invertir_en=None,nuevo=None,nuevo_en=50000,nuevo_val='veneno',solap_B=None,
    ...
    return dict(mord=mord,vis=vis,W=W,comp=comp,deaths=deaths,log=log,
