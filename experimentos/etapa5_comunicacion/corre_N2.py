...
VAR_KW = {'a': dict(), 'b': dict(gamma_sim=1.2, baseline_q=True, u_m=1.0),   # N2b: PREREGISTRO_N2b.md
          ...
          'd': dict(gamma_sim=1.2, baseline_q=True, u_m=1.0, estado_emisor='valor_rapido', u_v=0.5),   # N2d: PREREGISTRO_N2d.md
          'e': dict(gamma_sim=1.2, baseline_q=True, u_m=1.0, estado_emisor='valor_rapido', u_v=0.5, alinea=True)}[VARIANTE]   # N2e: PREREGISTRO_N2e.md
T_PROG = {'a': 200000, 'b': 200000, 'c': 400000, 'd': 400000, 'e': 400000}[VARIANTE]   # N2c/d/e: el experto es experto
PREF = {'a': 'N2', 'b': 'N2b', 'c': 'N2c', 'd': 'N2d', 'e': 'N2e'}[VARIANTE]
...
if __name__ == '__main__':
    ...
    pre = os.path.join(AQUI, {'a': 'PREREGISTRO_N2.md', 'b': 'PREREGISTRO_N2b.md', 'c': 'PREREGISTRO_N2c.md', 'd': 'PREREGISTRO_N2d.md', 'e': 'PREREGISTRO_N2e.md'}[VARIANTE])
