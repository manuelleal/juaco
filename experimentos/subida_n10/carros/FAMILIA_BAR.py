"""carros/FAMILIA_BAR.py (CONSTRUIDO por experimentos/subida_n10/construye_familia.py desde carros/FABRICA.py,
sha 2ebee3e99ea5a33a; NO editar a mano). SUBIDA_N10: el nodo viaja en el PARTO (MODO = 'bar'). Con MODO = 'nada' es FABRICA.
...
MODO = 'bar'   # SUBIDA_N10: nada | parto | bar | oraculo
