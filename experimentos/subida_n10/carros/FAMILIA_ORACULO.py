"""carros/FAMILIA_ORACULO.py (CONSTRUIDO por experimentos/subida_n10/construye_familia.py desde carros/FABRICA.py,
sha 2ebee3e99ea5a33a; NO editar a mano). SUBIDA_N10: el nodo viaja en el PARTO (MODO = 'oraculo'). Con MODO = 'nada' es FABRICA.
...
MODO = 'oraculo'   # SUBIDA_N10: nada | parto | bar | oraculo
