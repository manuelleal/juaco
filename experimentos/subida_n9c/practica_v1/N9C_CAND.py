"""carros/N9C_CAND.py (CONSTRUIDO por experimentos/subida_n9c/construye_n9c.py desde carros/FABRICA.py, sha 2ebee3e99ea5a33a;
NO editar a mano). SUBIDA_N9C: BOCA = 'deriva', HER = 'todo'. Con BOCA = 'activa' y HER = 'nada' es FABRICA.
...
BOCA = 'deriva'   # SUBIDA_N9C: activa | deriva
HER = 'todo'   # SUBIDA_N9C: nada | todo | cruz
