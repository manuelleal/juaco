"""carros/N9C_BOCA.py (CONSTRUIDO por experimentos/subida_n9c/construye_n9c.py desde carros/FABRICA.py, sha 2ebee3e99ea5a33a;
NO editar a mano). SUBIDA_N9C: BOCA = 'deriva', HER = 'nada'. Con BOCA = 'activa' y HER = 'nada' es FABRICA.
...
HER = 'nada'   # SUBIDA_N9C: nada | todo | cruz
