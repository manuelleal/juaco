"""carros/N9C_HER.py (CONSTRUIDO por experimentos/subida_n9c/construye_n9c.py desde carros/FABRICA.py, sha 2ebee3e99ea5a33a;
NO editar a mano). SUBIDA_N9C: BOCA = 'activa', HER = 'todo'. Con BOCA = 'activa' y HER = 'nada' es FABRICA.
