"""carros/N9C_NADA.py (CONSTRUIDO por experimentos/subida_n9c/construye_n9c.py v2 desde carros/FABRICA.py, sha 2ebee3e99ea5a33a;
NO editar a mano). SUBIDA_N9C: BOCA = 'activa', HER = 'nada'. Con BOCA = 'activa' y HER = 'nada' es FABRICA.
...
BOCA = 'activa'   # SUBIDA_N9C: activa | predice
