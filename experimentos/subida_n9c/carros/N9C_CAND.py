"""carros/N9C_CAND.py (CONSTRUIDO por experimentos/subida_n9c/construye_n9c.py v2 desde carros/FABRICA.py, sha 2ebee3e99ea5a33a;
NO editar a mano). SUBIDA_N9C: BOCA = 'predice', HER = 'memoria'. Con BOCA = 'activa' y HER = 'nada' es FABRICA.
...
BOCA = 'predice'   # SUBIDA_N9C: activa | predice
HER = 'memoria'   # SUBIDA_N9C: nada | memoria | cruz
