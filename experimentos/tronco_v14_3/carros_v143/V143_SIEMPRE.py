"""V143_SIEMPRE.py — tronco_v14_3 (candidato a tronco v14.3): FABRICA + B-5 + FILTRO con META + boca TD de APR.
GENERADO por experimentos/tronco_v14_3/construye_v143.py desde carros/APR.py (sha 4402aa5142065c72). NO editar a mano.
Perillas: DESAMB 1 FILTRO 1 META 0 INVIERTE 0 OPCION 1. Con DESAMB = FILTRO = OPCION = 0 es FABRICA bit a bit. Sigue el docstring de APR.
...
DESAMB = 1; FILTRO = 1; META = 0; INVIERTE = 0   # tronco_v14_3: LA UNICA LINEA QUE CAMBIA ENTRE VARIANTES (con OPCION)
