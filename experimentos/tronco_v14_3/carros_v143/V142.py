"""V142.py — tronco_v14_3 (candidato a tronco v14.3): FABRICA + B-5 + FILTRO con META + boca TD de APR.
GENERADO por experimentos/tronco_v14_3/construye_v143.py desde carros/APR.py (sha 4402aa5142065c72). NO editar a mano.
Perillas: DESAMB 1 FILTRO 0 META 1 INVIERTE 0 OPCION 0. Con DESAMB = FILTRO = OPCION = 0 es FABRICA bit a bit. Sigue el docstring de APR.
