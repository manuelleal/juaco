...
Uso:  python experimentos/nivel10_composicion_v14/identidad_v14_rapido.py [--T 30000] [--rapido]
"""
...
import organismo_v14c_on as LENTO           # el TRONCO v14, interpretado (las dos perillas ON por defecto)
