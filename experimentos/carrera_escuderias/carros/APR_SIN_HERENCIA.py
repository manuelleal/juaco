"""carros/APR_SIN_HERENCIA.py — APR (camino A, experimentos/aprende_barrer): FABRICA + la OPCION APRENDIDA de morder lo malo conocido.
GENERADO por experimentos/aprende_barrer/construye_apr.py desde carros/FABRICA.py (sha 2ebee3e99ea5a33a). NO editar a mano.
MODO sin_herencia. Con OPCION = 0 es FABRICA bit a bit (identidad_apr.py). Lo que sigue es el docstring de FABRICA.
