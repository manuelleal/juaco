"""bateria_generaliza_v143 = organismo/bateria_generaliza_v142.py (e5929942647756a5, CONGELADA: solo se leyo) con UNA
...
INSTRUMENTOS = {
    ...
    'organismo_v143': ('organismo_v143g', dict(eta_s=0.15, clip_s=10.0, puerta=3, mask_rel=2, del_s=0.25, del_c=0.25, ema_c=0.05, puerta_pat=5, pat_shuf=0, pat_min=1)),   # v14.3 = v14.2 + N (norm_lenta=1 por defecto en organismo_v143g): kwargs CAMPO A CAMPO iguales a los de organismo_v142 (regla 14)
}
...
if __name__ == '__main__':
    ...
    _dir = {'organismo_v14g': AQUI, 'organismo_v142g': AQUI, 'organismo_v143g': AQUI, 'organismo_v11g': GEN, 'organismo_v13g': os.path.join(RAIZ, 'experimentos', 'v13_dos_vias'),
