"""organismo_v13gE_k3 = organismo_v13pg.py (910f1f5fb64453bb) + dE-TEST FIJO ON por defecto: eta_pred=0.03, ema_pred=0.05,
k_testE=3.0 (las mismas constantes que organismo_v13E_k3). Mundo de regla, para bateria_generaliza_E.py.
Generado por construye_v13E.py --k 3. NO editar. Con eta_pred=ema_pred=k_testE=0 es organismo_v13pg EXACTO."""
