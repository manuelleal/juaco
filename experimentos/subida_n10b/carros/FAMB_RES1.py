"""carros/FAMB_RES1.py (CONSTRUIDO por experimentos/subida_n10b/construye_familia_b.py desde carros/FABRICA.py,
sha 2ebee3e99ea5a33a; NO editar a mano). SUBIDA_N10B: la familia pasa su TABLA en el parto (MODO = 'res1'). Con MODO = 'nada' es FABRICA.
...
MODO = 'res1'   # SUBIDA_N10B: nada | res | res1 | bar | oraculo
_TABLA = ('res', 'res1', 'bar')
