"""carros/FAMB_NADA.py (CONSTRUIDO por experimentos/subida_n10b/construye_familia_b.py desde carros/FABRICA.py,
sha 2ebee3e99ea5a33a; NO editar a mano). SUBIDA_N10B: la familia pasa su TABLA en el parto (MODO = 'nada'). Con MODO = 'nada' es FABRICA.
...
MODO = 'nada'   # SUBIDA_N10B: nada | res | res1 | bar | oraculo
_TABLA = ('res', 'res1', 'bar')
