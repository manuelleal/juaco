"""organismo_v13q6 = organismo_v13q5.py (fae9c32b146fdbb4) + perilla `ntr` (tamano del tren del mundo de regla).
Con ntr=None es organismo_v13q5 EXACTO (identidad obligatoria: identidad_v13q6.py), y con las perillas
`seleccion` y `lab` tambien apagadas, organismo_v13q3 exacto.
AVISO: mover `ntr` cambia el MUNDO (sube el tren, baja el test). Declarado en PREREGISTRO_xor_6.md.
Generado por experimentos/creacion_A/construye_v13q6.py. NO editar a mano."""
