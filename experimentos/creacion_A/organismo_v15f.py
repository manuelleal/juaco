"""organismo_v15f = organismo/organismo_v14.py (feefc88b1fd8d434, TRONCO v14.1 CONGELADO: solo se leyo) + perilla
`memoria_pares` = None | 'relevo' (mem_alfa=1.0): tabla de pares con R CRUDO y sobrescritura; la via lenta lee la tabla si
conoce la combinacion y si no la lineal; cada via aprende de su propio error. Con None es organismo_v14 EXACTO y no se
consume ni un numero del rng (identidad_v15f.py). Generado por construye_v15f.py. NO editar a mano."""
