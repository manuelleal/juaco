"""organismo_v14_e015c10 = organismo/organismo_v14.py (9bab8ac0685b1f21, TRONCO CONGELADO: solo se leyo) con las
DOS CONSTANTES de la via lenta cambiadas por defecto: eta_s 0.015 -> 0.15 y clip_s 3.0 -> 10.0
(propuesta A-4 del creador A). NINGUNA linea de logica cambia. Llamandolo con eta_s=0.015, clip_s=3.0 es
organismo_v14 EXACTO (identidad obligatoria: identidad_v14_e015c10.py).
Generado por experimentos/creacion_A/construye_v14_e015c10.py. NO editar a mano."""
