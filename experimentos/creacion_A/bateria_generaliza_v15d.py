...
INSTRUMENTOS = {
    ...
    'organismo_v15d_on': ('organismo_v15gd_on', dict(puerta=3, mask_rel=2, del_s=0.25, del_c=0.25, ema_c=0.05, puerta_pat=5, pat_shuf=0, pat_min=1)),   # v15d: lineal + tabla de pares (suma)
}
