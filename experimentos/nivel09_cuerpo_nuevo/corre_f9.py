...
UMBRALES = {
    'F9-1': dict(frase="ANCLA (BLOQUEANTE): el instrumento no se movio -- NADA reproduce NADA_CM de H-1 y "
                 ...
                 R0_NADA=(0.10, 0.22), vida_NADA=(float(os.environ.get('F9_VIDA_NADA_MIN', '90.0')), 170.0), R0_RENACE=(0.70, 1.40), r_RENACE=(-50.0, 25.0)),  # ERR-92: minimo de vida_NADA por F9_VIDA_NADA_MIN (ENMIENDA_ERR92_ancla.md); 90.0 = letra original
