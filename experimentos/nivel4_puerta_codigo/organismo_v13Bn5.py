"""organismo_v13Bn5 = organismo_v13B.py con puerta_pat = 5 POR DEFECTO (PAT: solo evidencia del codigo). El mismo archivo con UNA constante cambiada, para
que bateria_v13B.py lo examine con la perilla encendida sin tocar la bateria congelada.
...
def run(seed,T=100000,learn=True,invertir_en=None,nuevo=None,nuevo_en=50000,nuevo_val='veneno',solap_B=None,
        eta=.03,tau_e=.85,alpha=1.2,hambre_boca=2.0,aversion=1.0,costo=.002,nobj=4,log_cada=None,plast=True,theta=0.6,ema=0.02,paso=0.5,solap_AB=None,lam=0.05,memoria_rechazo=20,mu_norm=True,div_signo=True,eta_s=0.015,clip_s=3.0,puerta=3,puerta_pat=5,pat_shuf=0,pat_min=0):
