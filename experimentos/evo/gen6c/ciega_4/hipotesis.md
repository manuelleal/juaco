...
linea del cuerpo de run() #18: `err_max=0.0; t_conflicto=None; t_techo=None; n_techo=0   # instrumentacion v8, solo lectura`
constante 0.0 -> 0.0 (factor 1.037)
