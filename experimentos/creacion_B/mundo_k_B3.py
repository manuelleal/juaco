"""mundo_k_B3 = mundo_k_B2.py (e7f8d22b599a8f16) + medias condicionadas por clase (mup/mun con
...
"""mundo_k_B2 = mundo_k_B.py (c123df80b77062d9) + traza error-firmada mus[c] + perilla mask_rel
...
"""mundo_k_B = mundo_temporal_k.py (68736baafe7c8cdb) + diagnostico del presupuesto de celdas + perilla
...
def run(seed, arm='C1', T=100000, learn=True, eta=.03, tau_e=.85, alpha=1.2,
        ...
        theta=0.6, ema=0.02, paso=0.5, early=5000, nkmax=NKMAX, wclip=3.0, lam=0.05, memoria_rechazo=20, mu_norm=False, div_signo=False, eta_s=0.0, clip_s=3.0, puerta=None, kprof=1, recic=0, tau_r=0, mask_rel=0, del_s=0.25, del_c=0.25, n_cf=1, ema_c=0.05):
