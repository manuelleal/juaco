...
## ERR-64b (coordinador, 19:58; ANTES de repetir): a T = 60 000 sigue habiendo 1/3 semillas del arnés en las que CANAL-k5 ≡ CORTADO-k5 porque el mensaje no se entrega en esa semilla; los controles que DEBEN diferir prueban la no-vacuidad con ≥ 2 de 3. Los casos de identidad (apagado ≡ original) siguen exigiendo 3/3. Ningún umbral R1–R6 ni puerta P-I cambia.
