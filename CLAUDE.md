...
> 21-sep-2026: v15f-v2 NO ENTRA (4 puertas de 7); BA cumple la misión cruda de la fase 5 ×2 pero no la letra R1–R5; LÍNEA CERRADA de memoria de pares en la vía lenta (v15c–v15g); línea BA/BA-v CERRADA (P6 cae en tres series bajo ERR-90; el valor falla por colisión estructural); fase 9 bloque 1 DECLARADO en parte con dos series válidas (1501–1520, 1621–1640): el cuerpo nuevo rechaza lo malo al primer encuentro sin dejar de comer y vive ~6.3× (H-1 en pie); F9-4 y F9-7 negativos ×3; propuesta nivel 9 → 40 % (50 si replica el bloque 2: F9-4bis pasa con J balanceado, ni el oráculo cruza R₀ 0.9, el muro es el mundo; el candidato C-F9B′ cae); criterio v3 calibrado con placebo: la serie acierta CAL-1..5 pero la réplica NO repite (CAL-1 0.898, CAL-4 un marginal fuera), v3 no utilizable, v4 pendiente; v2 rechaza al propio tronco en dos series (ERR-91); nivel 6 "rodeo obligado" CAE 5/10 (come más, no rodea); dE5 bajo el criterio v2 NO ENTRA (recupera 3.23× más rápido, pero muerde más veneno: cae T-A, T-C, T-E, T-G); ERR-87..90. Detalle en `registro/ESTADO.md`.
